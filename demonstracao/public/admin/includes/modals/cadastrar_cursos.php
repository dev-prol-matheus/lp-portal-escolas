        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #29166F; color: #FFF;">
                    <h5 class="modal-title" id="addCourseModalLabel">Cadastrar Novo Curso</h5>
                    ...
                    <form id="addCourseForm">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="valor" name="valor" placeholder="R$0,00 não é obrigatório ser preenchido">
                        </div>
                        <div class="mb-3">
                        ...
                        <button type="button" onclick="cadastrarCurso()" class="btn" style="background-color: #FEB21F; color: #FFF;">Salvar</button>
                    </form>
                </div>
